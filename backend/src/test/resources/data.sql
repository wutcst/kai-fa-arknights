...
INSERT INTO world_game_config (config_key, config_value, description) VALUES
('start_room_id', 'outside', '新游戏起始房间'),
('default_max_weight', '5', '玩家默认基础负重'),
('portal_seed', '20240612', '传送门固定随机种子');
...
('theater', 'main_campus', 'in a lecture theater', '训练设施', 'normal', 0, 2),
...
('theater_lobby', 'training_facility', 'in the theater lobby', '设施接待大厅', 'normal', 1, 13),
('theater_classroom_101', 'training_facility', 'in classroom 101', '基础训练室A', 'normal', 1, 14),
('theater_classroom_102', 'training_facility', 'in classroom 102', '基础训练室B', 'normal', 1, 15),
('theater_stairway_1f', 'training_facility', 'in the 1st floor stairway', '设施东侧通道', 'normal', 1, 16),
('theater_classroom_201', 'training_facility', 'in classroom 201', '进阶训练室A', 'normal', 2, 17),
('theater_classroom_202', 'training_facility', 'in classroom 202', '进阶训练室B', 'normal', 2, 18),
('theater_office', 'training_facility', 'in the teacher office', '人事档案室', 'normal', 2, 19),
('theater_stairway_2f', 'training_facility', 'in the 2nd floor stairway', '设施中央通道', 'normal', 2, 20),
('theater_classroom_301', 'training_facility', 'in classroom 301', '精英训练室A', 'normal', 3, 21),
('theater_classroom_302', 'training_facility', 'in classroom 302', '精英训练室B', 'normal', 3, 22),
('theater_lab', 'training_facility', 'in the computer lab', '制造站', 'normal', 3, 23),
('theater_stairway_3f', 'training_facility', 'in the 3rd floor stairway', '设施顶层通道', 'normal', 3, 24);
...
INSERT INTO world_items (item_id, item_name, description, weight, item_value) VALUES
('orirock','源岩','最基础的岩石原料，广泛用于初级加工与制造，能从几乎所有岩层中采集到。',1,5),
('orirock_cube','固源岩','将源岩粉碎后重组而成的坚固立方体，基建制造与干员初期精英化的常用素材。',1,10),
('orirock_concentration','提纯源岩','经过多道工序提纯的高密度源岩，硬度极高，是高级精英化与专精的基石材料。',2,50),
('device','装置','功能完好的通用型机械装置，是制造全新装置和合成各类精密仪器的中间产物。',3,60),
('loxic_kohl','扭转醇','具有特殊旋光性的醇类化合物，是合成白马醇等多种关键药物与工业品的前置原料。',1,15),
('white_horse_kohl','白马醇','由扭转醇精制而成的纯白醇类，性质极其稳定，高级术师与治疗干员技能专精的消耗品。',2,80),
('integrated_device','全新装置','刚从生产线下来的精密装置，性能处于最佳状态，为精英化二阶段和关键技能专精所必需。',3,200),
('crystalline_component','晶体元件','从晶体矿物上切割下的基础电子元件，是构建晶体电路等复杂系统的起点。',2,100),
('crystalline_circuit','晶体电路','集成了多个晶体元件的高密度电路模块，运算性能强大，用于高级技能专精与模组数据块制造。',4,500),
('rma70_12','RMA70-12','源石技艺与现代工业结合的半成品，编号70-12，稀有度高，是多种高端电子元件的基板。',2,120),
('oriron','异铁','在天然磁场中生成的奇异铁矿石，采集后可用于熔炼异铁组，是基础工业原料之一。',1,20),
('oriron_shard','异铁碎片','开采异铁矿时产生的碎片，可合成完整异铁，常用于初期武器与装备的强化。',1,8),
('sugar','糖','便携式高能代糖补给，不仅是干员作战时的能量来源，也是制造糖组的基本材料。',1,12),
('sugar_pack','糖组','将糖压缩包装后的能量块，便于大量储存与运输，是中期精英化和技能升级的常见需求。',2,40),
('polyketon','酮凝集','有机聚合物形成的凝胶状物质，可作为粘合剂与绝缘层，是制造站首批可生产的材料之一。',1,5),
('sugar_lump','糖聚块','高度提纯并聚合的糖晶体，蕴含惊人能量，仅供顶尖技能的专精与模组升级使用。',2,100),
('aketon','酮凝集组','酮凝集经过压缩和固化处理后的块状物，绝缘与隔源性能优异，极受术师干员青睐。',2,50),
('polyester','聚酸酯','常见的合成树脂原料，轻便且易于塑形，是制造聚酸酯组和部分家具零件的基础素材。',1,15),
('polyester_pack','聚酸酯组','多份聚酸酯的标准化封装包，便于运输与管理，满足干员中期精英化的大量消耗。',2,45),
('oriron_cluster','异铁组','由数块异铁组合而成的标准加工单元，广泛用于重装干员的精英化与防御装备制造。',2,80),
('keton_colloid','酮阵列','在特殊条件下令酮凝集组规整排列形成的胶体阵列，结构极度稳定，用于尖端的源石技艺强化。',3,200),
('grindstone','研磨石','表面密布研磨颗粒的工具石，能将粗加工部件打磨至微米级精度，泛用性极高。',2,60),
('grindstone_pentahydrate','五水研磨石','含有五个结晶水的特殊研磨石，研磨精度进一步提升，是生产双极纳米片等顶级材料的关键。',3,250),
('rma70_24','RMA70-24','RMA70-12的深度加工型，内部回路更为复杂，专为精英化二阶段及精密仪器制造而设计。',3,300),
('incandescent_alloy','炽合金','能在极高温度下保持稳定的合金，是制作武器隔热层与源石蚀刻回路的重要材料。',2,150),
('damaged_device','破损装置','在冲突中受损的机械装置，虽然无法直接使用，但拆解后仍能回收若干标准零件。',3,30),
('oriron_block','异铁块','将异铁组熔炼锻压成的超合金块，坚不可摧，是重装与部分近卫干员专精的顶级材料。',4,400),
('compound_cutting_fluid','化合切削液','用于精密加工的特种化学液，能显著提升材料切割精度，是维多利亚篇章后出现的新素材。',3,180),
('incandescent_alloy_block','炽合金块','炽合金的锻压块，耐热极限更为出色，近卫与狙击干员高阶专精的必备消耗品。',4,450),
('refined_solvent','精炼溶剂','经过多重蒸馏的超纯溶剂，能溶解绝大多数顽固原料，是制造聚合凝胶和聚合剂的必需品。',2,120),
('semi_synthetic_solvent','半自然溶剂','天然提取物与合成溶剂的混合物，调和了效能与成本，是精炼溶剂的前置半成品。',1,40),
('cutting_fluid_solution','切削原液','未经稀释的高浓度切削液，切割能力极强，但直接使用风险大，须调配成化合切削液。',2,60),
('polyester_lump','聚酸酯块','由聚酸酯组高压聚合而成的硬质块体，强度远超普通酯类，用于精英化二阶段的防具制作。',3,200),
('gel','凝胶','具有良好的生物相容性的透明凝胶，常用于伤口处理与精密仪器润滑。',3,150),
('gold','赤金','高纯度的黄金，在罗德岛作为通用货币流通，也可用于高级装备的镀层处理。',2,100),
('polymerized_gel','聚合凝胶','通过高分子聚合而成的特殊凝胶，拥有惊人的吸附与缓冲能力，广泛应用于医疗与防护插板。',5,1500),
('diketone','双酮','含有两个酮基的有机化合物，是多种药物合成的关键中间体。',1,50),
('trans_salt_group','转质盐组','经过特殊工艺处理的盐类化合物，常用于源石技艺的媒介转换。',2,100),
('ring_preform','环烃预制体','未完成环化反应的烃类化合物，是合成高级材料的中间体。',1,60),
('trans_salt_block','转质盐聚块','高密度的转质盐结晶块，用于重装干员的高阶精英化。',4,350),
('modified_device','改量装置','经过改装调整的测量设备，可用于精密仪器的校准工作。',2,80),
('ester_raw','酯原料','生产聚酯类材料的基础原料，通过加工可制成多种工业用品。',1,35),
('carbon','碳','最基础的碳元素材料，可用于多种合成反应的原料。',1,10),
('carbon_fiber','碳素','高强度碳纤维材料，是制造轻质高强度装备的关键原料。',2,90),
('orirock_cluster','固源岩组','多块固源岩的组合包装，便于大批量运输和使用。',2,45),
('light_manganese','轻锰矿','含有锰元素的轻质矿物，是冶炼特种合金的原料之一。',1,55),
('magic_cookie','理智增强剂','罗德岛开发的特殊药剂，注射可以增加负重',1,0);
...
INSERT INTO world_random_spawn_rules (rule_id, item_id, min_count, max_count, random_seed, enabled) VALUES
('magic_cookie_default','magic_cookie',5,10,20240612,true);

INSERT INTO world_random_spawn_candidates (rule_id, room_id, grid_row, grid_col, display_order) VALUES
('magic_cookie_default','outside',6,2,1),('magic_cookie_default','pub',6,2,2),('magic_cookie_default','lab',6,6,3),('magic_cookie_default','library',2,2,4),
('magic_cookie_default','gym',6,2,5),('magic_cookie_default','cafeteria',6,2,6),('magic_cookie_default','garden',2,6,7),('magic_cookie_default','bookstore',6,2,8),
('magic_cookie_default','theater_lobby',6,2,9),('magic_cookie_default','theater_classroom_101',6,6,10),('magic_cookie_default','theater_classroom_102',6,6,11),
('magic_cookie_default','theater_classroom_201',6,6,12),('magic_cookie_default','theater_classroom_202',6,6,13),('magic_cookie_default','theater_office',5,3,14),
('magic_cookie_default','theater_classroom_301',6,2,15),('magic_cookie_default','theater_classroom_302',2,6,16),('magic_cookie_default','theater_lab',6,2,17);
