...
public class RoomTest {
    ...
    void testClassroomNames() {
        ...
        assertEquals("101教室", classroom101.getZhName());
        assertEquals("一楼楼梯间", stairway.getZhName());
        assertEquals("教师办公室", office.getZhName());
    }
}